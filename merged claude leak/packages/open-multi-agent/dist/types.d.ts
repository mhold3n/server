...
export interface AgentConfig {
    readonly name: string;
    readonly model: string;
    readonly provider?: 'anthropic' | 'copilot' | 'grok' | 'openai' | 'gemini' | 'ollama';
    /**
...
export interface OrchestratorConfig {
    ...
    readonly defaultProvider?: 'anthropic' | 'copilot' | 'grok' | 'openai' | 'gemini' | 'ollama';
    readonly defaultBaseURL?: string;
    readonly defaultApiKey?: string;
    /**
     * When false, built-in tools (bash, file_*, grep) are not registered.
     * Use with {@link extraTools} for sandboxed or platform-scoped deployments.
     */
    readonly enableBuiltInTools?: boolean;
    /** Additional tools registered on every agent built by the orchestrator. */
...
export interface LLMAdapter {
    ...
    /**
     * Optional lightweight provider health probe.
     */
    health?(): Promise<{
        healthy: boolean;
        models?: string[];
