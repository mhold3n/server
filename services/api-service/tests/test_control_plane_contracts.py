...
def test_golden_fixture_file_matches_schema() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/task-packet/valid-minimal.json"
    )
...
def test_golden_task_queue_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/task-queue/valid-minimal.json"
    )
...
def test_golden_engineering_state_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/engineering-state/valid-minimal.json"
    )
...
def test_golden_knowledge_pool_assessment_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/knowledge-pool-assessment/valid-minimal.json"
    )
...
def test_golden_routing_policy_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/routing-policy/valid-minimal.json"
    )
...
def test_golden_environment_spec_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/environment-spec/valid-minimal.json"
    )
...
def test_golden_gui_session_spec_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/gui-session-spec/valid-minimal.json"
    )
...
def test_golden_verification_report_round_trip() -> None:
    data = _load_fixture(
        "xlotyl/services/response-control-framework/schemas/control-plane/v1/fixtures/verification-report/valid-minimal.json"
    )
