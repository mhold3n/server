...
def main():
    ...
    parser.add_argument(
        "--humaneval", action="store_true", help="Prepare HumanEval dataset"
    )
    parser.add_argument(
        "--code-review", action="store_true", help="Prepare code review dataset"
    )
    parser.add_argument(
        "--documentation", action="store_true", help="Prepare documentation dataset"
    )
    parser.add_argument(
        "--prompts", action="store_true", help="Create training prompts"
    )
    parser.add_argument(
        "--shadow-prompts", action="store_true", help="Validate shadow prompts dataset"
    )
