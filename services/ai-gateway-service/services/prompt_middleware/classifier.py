...
INTENT_KEYWORDS = {
    ...
    "instrument_contention_before_tuning": [
        "contention",
        "index",
        "write pattern",
        "skew",
    ...
    "separate_user_errors_from_system_faults": [
        "recoverable",
        "system faults",
        "guaranteed",
        "ops",
    ],
    "revisit_cache_boundary_and_policy": [
        "cache",
        "expiration",
        "coalesce",
        "precompute",
    ...
    "add_checkpoints_and_idempotent_retries": [
        "checkpoint",
        "retry",
        "resume",
        "temp state",
    ...
    "introduce_time_scheduler_abstractions": [
        "concurrency",
        "time",
        "scheduling",
        "reliably",
    ],
    "resource_guardrails_for_backfills": [
        "backfill",
        "off-hours",
        "starve",
        "interactive",
    ],
    "isolate_global_state_incrementally": [
        "global state",
        "reordering",
        "incrementally",
        "refactor",
    ],
    "observable_backoff_and_circuit_breaker": [
        "retries",
        "backoff",
        "circuit",
        "maintenance",
    ],
    "reduce_layout_thrash_and_stage_updates": [
        "layout",
        "thrash",
        "main thread",
        "typing",
    ],
    "wrap_metaprogramming_with_explicit_api": [
        "metaprogramming",
        "boilerplate",
        "contributors",
        "magic",
    ],
    "schema_compatibility_policy_checks": [
        "schema",
        "compatibility",
        "forward",
        "back",
    ],
    "align_event_and_processing_time": [
        "event-time",
        "processing-time",
        "skew",
        "reconciliation",
    ...
    "prune_noise_and_surface_runbook_signals": [
        "runbook",
        "dashboards",
        "noise",
        "signals",
