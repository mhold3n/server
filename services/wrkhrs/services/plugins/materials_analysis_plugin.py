...
class MaterialsAnalysisPlugin:
    ...
    def estimate_fatigue_life(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if stress_amplitude <= endurance_limit:
            ...
            cycles_to_failure = (
                (stress_amplitude / fatigue_strength_coefficient)
                ** (1 / fatigue_strength_exponent)
            ) / 2
    ...
    def calculate_composite_properties(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if orientation == "unidirectional":
            ...
            E_longitudinal = (
                fiber_volume_fraction * fiber_properties["elastic_modulus"]
        ...
        # Density
        density = (
            fiber_volume_fraction * fiber_properties["density"]
            + matrix_volume_fraction * matrix_properties["density"]
        )

        # Strength (simplified)
        strength = fiber_volume_fraction * fiber_properties.get(
            "strength", 0
    ...
    def analyze_grain_size(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        yield_strength = base_yield_strength + hall_petch_constant * (
            grain_size_m**-0.5
        )
    ...
    def _stress_invariant_I2(self, stress: StressState) -> float:
        ...
        return (
            stress.sigma_x * stress.sigma_y
            + stress.sigma_y * stress.sigma_z
            + stress.sigma_z * stress.sigma_x
            - stress.tau_xy**2
            - stress.tau_yz**2
            - stress.tau_zx**2
        )
    ...
    def _stress_invariant_I3(self, stress: StressState) -> float:
        ...
        return (
            stress.sigma_x * stress.sigma_y * stress.sigma_z
...
if __name__ == "__main__":
    ...
    result = materials.execute_tool(
        "stress_analysis",
        {"sigma_x": 100e6, "sigma_y": 50e6, "sigma_z": 0, "tau_xy": 25e6},
    )
    ...
    result = materials.execute_tool(
        "material_properties", {"material_id": "steel_1018"}
    )
