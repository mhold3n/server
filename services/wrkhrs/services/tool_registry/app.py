...
class ToolRegistry:
    ...
    def list_tools(self) -> List[Dict[str, Any]]:
        ...
        return [
            {"name": name, "type": tool_data["type"], **tool_data["info"]}
...
async def list_tools():
    """List all available tools"""
    return {"tools": tool_registry.list_tools(), "count": len(tool_registry.tools)}
...
async def get_tool_info(tool_name: str):
    ...
    return {"name": tool_name, "type": tool["type"], **tool["info"]}
