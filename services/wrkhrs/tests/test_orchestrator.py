...
class TestWorkflowFunctions:
    ...
    def test_analyze_request_mechanical_detection(self, sample_workflow_state):
        ...
        sample_workflow_state.messages = [
            {
                "role": "user",
                "content": "Calculate the stress on a steel beam under 100N force",
            }
        ]
    ...
    def test_gather_context_success(
        self, mock_tools, mock_search, sample_workflow_state
    ):
...
class TestWorkflowState:
    ...
    def test_workflow_state_creation(self):
        ...
        state = WorkflowState(messages=[{"role": "user", "content": "test"}])
