    ...
    def __init__(self):
        ...
        self.domain_patterns = {
            ...
            "software_engineering": {
                "keywords": [
                    "algorithm", "backend", "frontend", "database", "api", "framework", 
                    "server", "client", "kubernetes", "docker", "python", "rust", "javascript",
                    "typescript", "html", "css", "git", "repository", "commit", "branch",
                    "merge", "pull request", "debugging", "exception", "compiler",
                    "interpreter", "runtime", "dependency", "module", "package", 
                    "deployment", "continuous integration", "pipeline", "function", 
                    "class", "object", "interface", "Birtha", "Claw", "mbmh"
                ],
                "formulas": [
            ...
            "systems_administration": {
                "keywords": [
                    "linux", "ubuntu", "debian", "macos", "bash", "shell", "terminal", 
                    "ssh", "firewall", "port", "daemon", "service", "proxy", "nginx",
                    "apache", "dns", "ip address", "subnet", "router", "switch", 
                    "permissions", "chmod", "chown", "sudo", "root", "filesystem", 
                    "mount", "cron", "log", "metrics", "monitoring", "prometheus", "grafana"
                ],
                "formulas": [
                    r"sudo \w+",
                    r"chmod [0-7]{3,4}",
            ...
            "ai_ml": {
                "keywords": [
                    "model", "training", "inference", "dataset", "neural network", 
                    "deep learning", "machine learning", "transformer", "llm", "rag", 
                    "embedding", "vector db", "prompt", "fine-tuning", "lora", "peft", 
                    "quantization", "gguf", "safetensors", "huggingface", "pytorch", 
                    "tensorflow", "gradient", "loss", "optimizer", "learning rate", 
                    "epoch", "batch size", "activation function"
                ],
                "formulas": [
                    r"nn\.Module",
                    r"import torch",
                ...
                "units": [
                    "VRAM", "FLOPS", "TFLOPS", "parameters", "tokens"
                ],
            },
        }
