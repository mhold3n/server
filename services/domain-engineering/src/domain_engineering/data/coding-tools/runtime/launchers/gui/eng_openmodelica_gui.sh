...
GUI_ID="eng_openmodelica_gui"
IMAGE="birtha/knowledge-eng-openmodelica-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_openmodelica_gui" \
