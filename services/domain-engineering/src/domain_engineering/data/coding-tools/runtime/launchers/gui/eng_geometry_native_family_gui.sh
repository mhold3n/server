...
GUI_ID="eng_geometry_native_family_gui"
IMAGE="birtha/knowledge-eng-geometry-native-family-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_geometry_native_family_gui" \
