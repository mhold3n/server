...
GUI_ID="eng_sparse_direct_family_gui"
IMAGE="birtha/knowledge-eng-sparse-direct-family-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_sparse_direct_family_gui" \
