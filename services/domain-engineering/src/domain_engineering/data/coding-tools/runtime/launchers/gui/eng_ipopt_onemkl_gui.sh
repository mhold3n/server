...
GUI_ID="eng_ipopt_onemkl_gui"
IMAGE="birtha/knowledge-eng-ipopt-onemkl-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_ipopt_onemkl_gui" \
