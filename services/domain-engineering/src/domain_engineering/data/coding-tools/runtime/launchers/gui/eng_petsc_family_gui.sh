...
GUI_ID="eng_petsc_family_gui"
IMAGE="birtha/knowledge-eng-petsc-family-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_petsc_family_gui" \
