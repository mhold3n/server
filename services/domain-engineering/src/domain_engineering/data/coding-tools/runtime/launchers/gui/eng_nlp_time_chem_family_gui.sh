...
GUI_ID="eng_nlp_time_chem_family_gui"
IMAGE="birtha/knowledge-eng-nlp-time-chem-family-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_nlp_time_chem_family_gui" \
