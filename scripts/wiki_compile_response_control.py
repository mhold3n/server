...
# Resolve api-service ``src`` package (contracts / Pydantic models).
REPO_ROOT = Path(__file__).resolve().parent.parent
_API_SERVICE_SRC = REPO_ROOT / "services" / "api-service"
if str(_API_SERVICE_SRC) not in sys.path:
    sys.path.insert(0, str(_API_SERVICE_SRC))

from src.control_plane.contracts import (  # noqa: E402  pylint: disable=wrong-import-position
