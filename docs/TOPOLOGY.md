...
| Caddy (server) | 443 | 8443 | `docker/compose-profiles/docker-compose.server.yml` |
| Structure Gateway | 8000 | `$STRUCTURE_GATEWAY_PORT` (def 8090) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs Gateway | 8000 | `$WRKHRS_GATEWAY_PORT` (def 8091) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs Orchestrator | 8000 | `$WRKHRS_ORCH_PORT` (def 8081) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs RAG | 8000 | `$WRKHRS_RAG_PORT` (def 8082) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs ASR | 8000 | `$WRKHRS_ASR_PORT` (def 8084) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs Tools | 8000 | `$WRKHRS_TOOLS_PORT` (def 8086) | `docker/compose-profiles/docker-compose.ai.yml` |
| WrkHrs MCP | 8000 | `$WRKHRS_MCP_PORT` (def 8085) | `docker/compose-profiles/docker-compose.ai.yml` |
| MCP Registry | 8000 | `$MCP_REGISTRY_PORT` (def 8001) | `docker/compose-profiles/docker-compose.ai.yml` |
| Qdrant | 6333 | 6333 | `docker/compose-profiles/docker-compose.platform.yml` |
| MLflow | 5000 | 5000 | `docker/compose-profiles/docker-compose.platform.yml` |
| Prometheus | 9090 | 9090 | `docker/compose-profiles/docker-compose.platform.yml` |
| Grafana | 3000 | 3000 | `docker/compose-profiles/docker-compose.platform.yml` |
| Loki | 3100 | 3100 | `docker/compose-profiles/docker-compose.platform.yml` |
| Tempo | 3200/4317 | 3200/4317 | `docker/compose-profiles/docker-compose.platform.yml` |
| Jaeger | 16686 | 16686 | `docker/compose-profiles/docker-compose.platform.yml` |
| vLLM Gen (worker) | 8000 | `$WORKER_GEN_PORT` (def 8000) | `docker/compose-profiles/docker-compose.worker.yml` |
| vLLM Embed (worker) | 8001 | `$WORKER_EMBED_PORT` (def 8001) | `docker/compose-profiles/docker-compose.worker.yml` |
| Reranker (worker) | 8000 | `$WORKER_RERANKER_PORT` (def 8002) | `docker/compose-profiles/docker-compose.worker.yml` |
| Worker Caddy | 8443 | `$WORKER_PROXY_PORT` (def 8443) | `docker/compose-profiles/docker-compose.worker.yml` |
