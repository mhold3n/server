...
GUI_ID="eng_kratos_multiphysics_gui"
IMAGE="birtha/knowledge-eng-kratos-multiphysics-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_kratos_multiphysics_gui" \
