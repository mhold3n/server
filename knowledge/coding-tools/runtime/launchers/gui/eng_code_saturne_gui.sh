...
GUI_ID="eng_code_saturne_gui"
IMAGE="birtha/knowledge-eng-code-saturne-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_code_saturne_gui" \
