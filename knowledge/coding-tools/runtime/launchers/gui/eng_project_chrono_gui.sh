...
GUI_ID="eng_project_chrono_gui"
IMAGE="birtha/knowledge-eng-project-chrono-gui:1.0.0"
...
exec docker run --rm --platform "$PLATFORM" \
  ...
  -e "KNOWLEDGE_GUI_SESSION_REF=artifact://gui-session-spec/eng_project_chrono_gui" \
