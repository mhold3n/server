...
- **xlotyl** **owns** MCP servers as a product: the authoritative catalog, registry, and semantics live in the **[xlotyl](https://github.com/mhold3n/xlotyl)** repo under **`mcp-servers/mcp/config/mcp_servers.yaml`** (see also [`xlotyl/mcp-servers/README.md`](../xlotyl/mcp-servers/README.md) in the submodule).
