...
class CodeIndexer:
    ...
    def _initialize_parsers(self) -> Dict[str, Parser]:
        ...
        for lang, module_name in language_mappings.items():
            try:
                ...
                logger.warning("Failed to import parser", language=lang, module=module_name)
    ...
    async def index_repository(
        ...
        try:
            ...
            logger.error("Repository indexing failed", repository_path=repository_path, error=str(e))
            raise
