...
class CodeIndexer:
    ...
    def _extract_functions(self, ast_data: dict[str, Any] | None, language: str) -> list[dict[str, Any]]:
    ...
    def _extract_classes(self, ast_data: dict[str, Any] | None, language: str) -> list[dict[str, Any]]:
    ...
    def _extract_imports(self, ast_data: dict[str, Any] | None, language: str) -> list[dict[str, Any]]:
