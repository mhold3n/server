...
ts_stats = []
skip_dirs = ['node_modules', '.git', 'vendor', 'docs', 'dist', 'build', 'assets', '.svelte-kit', 'openclaw', 'claw-code-main']
...
print("Top 15 TypeScript source files needing comments (excluding submodules):")
